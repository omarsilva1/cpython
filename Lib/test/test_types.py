...
class IntersectionTests(unittest.TestCase):
    ...
    def test_and_types_operator(self):
        ...
        self.assertEqual(typing.List & typing.Tuple, typing.Intersection[typing.List, typing.Tuple])
        self.assertEqual(typing.List[int] & typing.Tuple[int], typing.Intersection[typing.List[int], typing.Tuple[int]])
        self.assertEqual(typing.List[int] & None, typing.Intersection[typing.List[int], None])
        self.assertEqual(None & typing.List[int], typing.Intersection[None, typing.List[int]])
        self.assertEqual(str & float & int & complex & int, (int & str) & (float & complex))
        self.assertEqual(typing.Intersection[str, int, typing.List[int]], str & int & typing.List[int])
        self.assertIs(int & int, int)
        self.assertEqual(
            BaseException &
            bool &
    ...
    def test_isinstance_and_subclasscheck(self):
        class A:
            pass
        class B:
            pass
        ...
        self.assertIsInstance(C(), typing.Intersection[A, B])
        # self.assertIsInstance(C(), typing.Intersection[B, A])
        self.assertIsInstance(C(), A & B)
        self.assertIsInstance(C(), B & A)
        self.assertNotIsInstance(C(), A & B & D)
        # self.assertTrue(issubclass(C, typing.Intersection[A, B]))
        # self.assertTrue(issubclass(C, typing.Intersection[B, A]))
        self.assertTrue(issubclass(C, A & B))
        self.assertTrue(issubclass(C, B & A))
        self.assertFalse(issubclass(C, A & B & D))
    ...
    def test_bad_instancecheck(self):
        class BadMeta(type):
            def __instancecheck__(cls, inst):
                1/0
        x = int & BadMeta('A', (), {})
        self.assertRaises(ZeroDivisionError, isinstance, 1, x)
    ...
    def test_bad_subclasscheck(self):
        class BadMeta(type):
            def __subclasscheck__(cls, sub):
                1/0
        x = int & BadMeta('A', (), {})
        self.assertRaises(ZeroDivisionError, issubclass, int, x)
